...
print("✓ 3D visualization demo created successfully!")
print(f"✓ Saved to: {output_file}")
print("✓ Open this file in a web browser to view the interactive 3D scene")
print("\nThe scene contains:")
print("  - 1 blue box at origin")
print("  - 1 red sphere at (2, 0, 0)")
print("  - 1 green cylinder at (0, 2, 0)")
print("  - 1 yellow sphere at (-1.5, -1.5, 0)")
print("\nInteractive controls:")
print("  - Click and drag to rotate")
print("  - Right-click and drag to pan")
print("  - Scroll to zoom")
print("  - Hover over objects to see their names")
